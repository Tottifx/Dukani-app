...
class CartService
{
    ...
    public function updateItemQuantity(int $product, int $quantity, $optionIds = null)
    {
        if (\Auth::check()) {
            $this->updateItemQuantityInDatabase($product, $quantity,$optionIds);
        } else {
            $this->updateItemQuantityInCookies($product, $quantity,$optionIds);
        }
    }
    ...
    public function saveItemToDatabase(int $productId, int $quantity, $price, array $optionIds): void
    {
        $userId = Auth::id();
        ksort($optionIds);
    ...
    public function saveItemToCookies(int $productId, int $quantity, $price, array $optionIds): void
    {
        $cartItems = $this->getCartItemsFromCookies();
